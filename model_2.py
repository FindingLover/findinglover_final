...
from settings import WIN_WIDTH, WIN_HEIGHT, BACKGROUND_IMAGE_2
...
class GameModel2:
    def __init__(self):
        #self.wave = 0
        self.bg_image = pygame.transform.scale(BACKGROUND_IMAGE_2, (WIN_WIDTH, WIN_HEIGHT))
        ...
        self.__plots = [Vacancy(465, 163), Vacancy(276, 166), Vacancy(390, 304), Vacancy(608, 309), #final
                        Vacancy(96, 324), Vacancy(97, 161), Vacancy(265, 410),
                        BlockVacancy(173, 463), BlockVacancy(163, 239), BlockVacancy(525, 243),
                        BlockVacancy(759, 251)]  # 8/17
