...
class GameModel:
    def __init__(self):
        ...
        self.__plots = [Vacancy(61, 94), Vacancy(183, 105),
                        Vacancy(335, 206), Vacancy(93, 314),
                        Vacancy(124, 439), Vacancy(470, 314),
                        Vacancy(747, 369),
                        Vacancy(616, 247), Vacancy(420, 139),
                        Vacancy(220, 518), Vacancy(339, 403),
                        BlockVacancy(504, 275), BlockVacancy(276, 106), BlockVacancy(239, 341)]
        ...
        self.max_hp = 9
        self.hp = self.max_hp
        self.max_love_grade = 7  #戀愛指數滿7 #更改
        ...
        self.sound.set_volume(0.5)  #音量調小
